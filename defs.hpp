...
#define randomizeserial_code CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0420, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define nullserial_code CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0079, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define customserial_code CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0323, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define changeserialoneveryreq_code CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0428, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define initiatespoof_code CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0072, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
